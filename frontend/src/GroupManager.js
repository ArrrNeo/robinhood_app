...
export const GroupRow = ({ group, groupId, metrics, positions, columns, columnOrder, onToggleCollapse, renderPositionCells, totalPortfolioValue, onEdit, onDelete }) => {
                                ...
                                content = (
                                    <div className="flex items-center space-x-2">
                                        ...
                                        {onDelete && (
                                            <button
                                                onClick={() => {
                                                    if (window.confirm(`Are you sure you want to delete the group "${group.name}"? All positions will be moved to ungrouped.`)) {
                                                        onDelete(groupId);
                                                    }
                                                }}
